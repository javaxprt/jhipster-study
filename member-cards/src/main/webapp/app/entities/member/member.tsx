  ...
  return (
    <div>
      <h2 id="member-heading" data-cy="MemberHeading">
        <Translate contentKey="memberCardsApp.member.home.title">Members</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="memberCardsApp.member.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/member/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="memberCardsApp.member.home.createLabel">Create new Member</Translate>
          </Link>
        </div>
      </h2>
        ...
        {memberList && memberList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="memberCardsApp.member.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="memberCardsApp.member.home.notFound">No Members found</Translate>
            </div>
          )
        )}
      </div>
