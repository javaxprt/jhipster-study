  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="memberCardsApp.member.home.createOrEditLabel" data-cy="MemberCreateUpdateHeading">
            <Translate contentKey="memberCardsApp.member.home.createOrEditLabel">Create or edit a Member</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('memberCardsApp.member.firstName')}
                id="member-firstName"
                name="firstName"
                data-cy="firstName"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('memberCardsApp.member.lastName')}
                id="member-lastName"
                name="lastName"
                data-cy="lastName"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('memberCardsApp.member.email')}
                id="member-email"
                name="email"
                data-cy="email"
                type="text"
