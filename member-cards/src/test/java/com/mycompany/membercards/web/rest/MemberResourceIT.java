...
import static com.mycompany.membercards.domain.MemberAsserts.*;
...
import com.mycompany.membercards.repository.MemberRepository;
...
class MemberResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "\"_z@X.>";
    private static final String UPDATED_EMAIL = "\"@T\\b-;\\.R,f4";
    ...
    public static Member createEntity() {
        return new Member().firstName(DEFAULT_FIRST_NAME).lastName(DEFAULT_LAST_NAME).email(DEFAULT_EMAIL);
    }
    ...
    public static Member createUpdatedEntity() {
        return new Member().firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL);
    }
    ...
    void putExistingMember() throws Exception {
        ...
        updatedMember.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL);
    ...
    void partialUpdateMemberWithPatch() throws Exception {
        ...
        partialUpdatedMember.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME);
    ...
    void fullUpdateMemberWithPatch() throws Exception {
        ...
        partialUpdatedMember.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL);
